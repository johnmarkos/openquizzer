...
export class OpenQuizzer {
  ...
  #handleMultipleChoiceSelect(index) {
    ...
    this.#answers.push({ problemId: problem.id, selected: index, correct: isCorrect });
  ...
  #gradeOrdering() {
    ...
    const isCorrect = this.#orderingOrder.every((originalIndex, position) =>
